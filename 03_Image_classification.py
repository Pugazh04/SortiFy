...
ESP32_CAM_URL = "<add your url to ESP32 cam>"
model_path = "<add your path to onnx model>"

session = ort.InferenceSession(model_path)
with open("<add your path to categories1.txt>", "r") as f:
